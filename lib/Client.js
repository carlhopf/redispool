...
Client.prototype.connect = function (cb) {
	...
	log.debug(this.tag, 'connecting');

	this.instance = redis.createClient(
		this.options.port,
		this.options.host,
		{
			// else will stop try to reconnect after 1 hour
			connect_timeout: Number.MAX_VALUE,
...
Client.prototype.end = function () {
	return this.instance.end.apply(this.instance, arguments);
};
